...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'crypto_platform.db',
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('MAIL_USERNAME', 'tu-correo@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('MAIL_PASSWORD', 'tu-app-password')
